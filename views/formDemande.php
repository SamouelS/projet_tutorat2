...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/projet_tutorat2/public/css/styleFormDemande.css">
    <!-- icons.css -->
...
<body>
    ...
    <nav>
        <div class="nav-wrapper grey darken-2">
            <a href="<?= $this->path ?>?action=display&vue=accueil" class="brand-logo"><img class="responsive-img"
                    src="<?= $this->path ?>/public/images/logo.png" width="60"></a>
            <a href="#" data-target="slide-out" class="sidenav-trigger"><i class="material-icons">menu</i></a>
            <ul class="right hide-on-med-and-down">
                <!-- Dropdown Trigger -->
                <li><a class="dropdown-button" data-target="dropdownDemande"><span
                            class="purple-text text-lighten-3">Demande</span><i
                            class="material-icons purple-text text-lighten-3 right">arrow_drop_down</i></a></li>
                <li><a class="dropdown-button" data-target="dropdownCours"><span
                            class="yellow-text text-darken-2">Cours</span> <i
                            class="material-icons yellow-text text-darken-2 right">arrow_drop_down</i></a></li>
                <li><a class="dropdown-button" data-target="dropdownAnalayse"><span
                            class="blue-text text text-lighten-1">Analyse</span> <i
                            class="material-icons blue-text text-lighten-1 right ">arrow_drop_down</i></a></li>
                <li><a class="dropdown-button" data-target="dropdownMenu"><i
                            class="material-icons left">person</i><?=$prenom.' '.$nom?></a></li>
            </ul>
        </div>
    </nav>
